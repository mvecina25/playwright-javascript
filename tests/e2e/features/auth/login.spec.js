            ...
            await test.step('THEN the user should be able to access all sidebar links successfully', async () => {
                const navigationScenarios = [
                    ...
                    },
                    {
                        ...
                        expectedTitle: 'Find Transactions',
                        urlFragment: 'findtrans.htm',
                    },
                    {
                        name: 'Update Contact Info',
                        expectedTitle: 'Update Profile',
                        urlFragment: 'updateprofile.htm',
                    },
                    {
                        name: 'Request Loan',
                        expectedTitle: 'Apply for a Loan',
                        urlFragment: 'requestloan.htm',
                    },
                ];
